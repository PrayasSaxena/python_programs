...
turtle.title('शिवलिंग Har Har Mahadev')
turtle.speed(0)
turtle.up()
turtle.hideturtle()
...
my_goto(-300, -300)
turtle.write('BY :-Prayas Saxena', font=("Bradley Hand ITC", 50, "bold"))  


my_goto(-150,150)
turtle.write('हर हर महादेव', font=("Bradley Hand ITC", 36, "bold"))  
turtle.done()